...
* ci(deps): bump actions/checkout from 4 to 6 by @dependabot[bot] in https://github.com/jigonr/statatest/pull/67
* ci(deps): bump actions/upload-artifact from 4 to 6 by @dependabot[bot] in https://github.com/jigonr/statatest/pull/66
* Add Claude Code GitHub Workflow by @jigonr in https://github.com/jigonr/statatest/pull/69
